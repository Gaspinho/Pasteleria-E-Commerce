...
export {default as CustomOrderDetails} from './pages/designtool/CustomOrderDetails';
...
export {default as StaffProfile} from './pages/staff/staffProfile';
export {default as NewStaff} from './pages/staff/NewStaff'; 
export {default as RolesPermissions} from './pages/roles/RolesPermissions';
