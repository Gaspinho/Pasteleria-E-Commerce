...
export const CustomOrderCheckoutStep2 = ({ onNext, onPrev }) => {
  ...
  // Obtener el total de la orden personalizada desde sessionStorage
  const getOrderTotal = () => {
    const customOrderAmount = sessionStorage.getItem("customOrderAmount");
    const deliveryCharges = 5000; // Costo de entrega fijo
    return customOrderAmount ? parseInt(customOrderAmount) + deliveryCharges : deliveryCharges;
  };
